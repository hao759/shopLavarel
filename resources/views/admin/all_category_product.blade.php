    ...
    <div class="panel panel-default">
        ...
        <div class="table-responsive">
          ...
          if ($item->category_status) {
            ?>
                            <a href="{{URL::to('/unactive-category-product/'.$item->category_id)}}"><span
        ...
        ?>
                        ...
                        <td>
                            <a href="{{URL::to('/edit_category_product/'.$item->category_id)}}" class="active"
                                ui-toggle-class="">
                                <i class="fa fa-check text-success text-active"></i></a>
                            <a onclick="return confirm('Are you sure?')"
                                href="{{URL::to('/delete_category_product/'.$item->category_id)}}" class="active"
                                ui-toggle-class="">
