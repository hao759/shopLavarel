                        ...
                        if($mess)
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="6" class="form-control" id="exampleInputPassword1" placeholder="Mô tả sản phẩm" name="product_description"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Giá sản phẩm</label>
                                    <textarea rows="6" class="form-control" id="exampleInputPassword1" placeholder="Mô tả sản phẩm" name="product_price"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Content sản phẩm</label>
                                    <textarea rows="6" class="form-control" id="exampleInputPassword1" placeholder="Mô tả sản phẩm" name="product_content"></textarea>
                                </div>
                                <div class="form-group" >
