                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        if ($item->brand_status) {
                          ?>
                            <a href="{{URL::to('/unactive-brand-product/'.$item->brand_id)}}"><span
                  ...
                  ?>
                        ...
                        <td>
                            <a href="{{URL::to('/edit_brand_product/'.$item->brand_id)}}" class="active"
                                ui-toggle-class="">
                                <i class="fa fa-check text-success text-active"></i></a>
                            <a onclick="return confirm('Are you sure?')"
                                href="{{URL::to('/delete_brand_product/'.$item->brand_id)}}" class="active"
                                ui-toggle-class="">
