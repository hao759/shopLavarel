    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        ...
        ?>
            ...
            <td>
              <a href="{{URL::to('/edit_product/'.$item-> product_id)}}" class="active" ui-toggle-class="">
                <i class="fa fa-check text-success text-active"></i></a>
              <a onclick="return confirm('Are you sure?')" href="{{URL::to('/delete_product/'.$item-> product_id)}}" class="active" ui-toggle-class="">
